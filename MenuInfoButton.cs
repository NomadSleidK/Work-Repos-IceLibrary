...
namespace MyIceLibrary
{
    ...
    public class MenuInfoButton : IMenu<ObjectsViewContext>
    {
        ...
        public MenuInfoButton(IObjectModifier modifier, IObjectsRepository objectsRepository)
        {
            _modifier = modifier;
        ...
        private void OpenMainWindow(IDataObject[] objects)
        {
            ...
            MainForm mainWindow = new MainForm(person.IsAdmin, objects);
        ...
        private void OpenCurrentObjectForm(Guid objectGuid)
        {
            ...
            ObserverFindedObjects observer = new ObserverFindedObjects(OnObjectsFinded);          
            dataObjects.Subscribe(observer);
        }

        private void OnObjectsFinded(IDataObject[] obj)
        {
